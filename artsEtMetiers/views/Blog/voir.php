				...
				<?php foreach ($wall['comment'] as $k => $v): ?>
					<div class="row-fluid block_com">
						...
						<div class="span10">	
							...
							<span><a href="#"><strong><?php echo $v['use_login'].'</strong></a> a écrit :'; ?></small></span>
							<?php if(isset(Auth::$session) && Auth::$session['use_id'] == $v['com_id_user'] || Auth::$session['use_statut'] >= 2): ?>
								<a href="<?php echo BASE_URL.'/blog/voir/'.$art['art_id'].'/'.$v['com_id'].'/'.$v['com_id_user']; ?>"><div class="edit pull-right"></div></a><a href="<?php echo BASE_URL.'/blog/delete/'.$v['com_id']; ?>"><div class="delete pull-right"></div></a>
							<?php endif; ?>
							<?php echo $this->Markitup->bbcodeParse($v['com_content'])?>
			...
			<div class="row-fluid form_comment_area">
				...
				<div class="row-fluid">
					...
					<div class="span10">
						...
						<?php echo $this->Form->create('blog/voir/'.$art['art_id'].'/'.$id = (isset($edit['com_id']))? $edit['com_id'] : '', array('type' => 'POST', 'name' => 'com_id', 'value' => $id)); ?>

						<?php echo $this->Form->input(array('name' => 'com_content', 'type' => 'textarea', 'rows' => 4, 'value' => $value = (isset($edit['com_content']))? $edit['com_content'] : '', 'class' => 'markitup')); ?>
