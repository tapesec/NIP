...
--
-- Client: localhost
-- Généré le: Dim 28 Avril 2013 à 20:29
...
INSERT INTO `pages` (`pag_id`, `pag_name`, `pag_url`) VALUES
(1, 'Blog', '/blog/index'),
(2, 'Parcours', '/parcours/index'),
(3, 'Portofolio', '/portofolio/index'),
(4, 'Forum', '/forum/index');
...
INSERT INTO `users` (`use_id`, `use_login`, `use_mail`, `use_password1`, `use_password2`) VALUES
(1, 'lionel', 'zdzdz', 'wolf1umip', 'zdzd'),
(2, 'lionel', '', 'wolf1umip', 'zdzzd'),
(3, 'lionel', '', 'wolf1umip', ''),
(4, 'lionel', 'zdzd', 'wolf1umip', 'zdzd');
