...
<div class="row-fluid">
	<div class="span12">
		...
		<p><?php echo $this->Markitup->bbcodeParse($art['art_content']); ?></p>
			...
			<div class="row-fluid form_comment_area">
				...
				<div class="row-fluid">
					...
					<div class="span10">
						...
						<?php echo $this->Form->create('blog/voir/'.$art['art_id'].'/'.$id = (isset($edit['com_id']))? $edit['com_id'] : '', array('type' => 'POST', 'name' => 'com_id', 'value' => $id, 'id' => 'comment')); ?>

						<?php echo $this->Form->input(array('name' => 'com_content',
															'type' => 'textarea',
															'rows' => 4,
															'value' => $value = (isset($edit['com_content']))? $edit['com_content'] : '',
															'class' => 'markitup',
															'id' => 'com_content',
