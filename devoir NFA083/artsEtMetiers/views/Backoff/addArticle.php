...
<div id="emoticons" class="emoticons_area">
	...
	<?php $this->Form->input(array('name' => 'art_content', 'type' => 'textarea','value' => $value = (isset($article['art_content']))? $article['art_content'] : '' , 'class' => 'markitup', 'rows' => 15, 'message' => true)); ?>
