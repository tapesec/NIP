...
<?php $this->Form->input(array('type' => 'text', 'label' => 'Titre du sujet (facultatif)', 'name' => 'sub_title', 'value' => $value = (isset($edit['sub_title']))? $edit['sub_title'] : '')); ?>
...
<?php $this->Form->input(array('type' => 'textarea', 'name' => 'sub_content', 'value' =>  $value = (isset($edit['sub_content']))? $edit['sub_content'] : '', 'rows' => 15, 'class' => 'markitup', 'message' => array('class' => 'text-error'))); ?>
